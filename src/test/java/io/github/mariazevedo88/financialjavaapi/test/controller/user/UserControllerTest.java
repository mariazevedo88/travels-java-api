package io.github.mariazevedo88.financialjavaapi.test.controller.user;
...
public class UserControllerTest {
	...
	static final String URL = "/financial/v1/users";
	...
	/**
	 * Method that fill a mock User to use as return in the tests.
	 * 
	 * @author Mariana Azevedo
	 * @since 13/12/2020
	 * 
	...
	/**
	 * Method that fill a mock UserDTO to use as return in the tests.
	 * 
	 * @author Mariana Azevedo
	 * @since 13/12/2020
	 * 
