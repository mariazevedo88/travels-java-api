...
public class StatisticsService {
	...
	/**
	 * Method that creates statistics based on the transactions that happened in the last 60 seconds.
	 * 
	 * @author Mariana Azevedo
	 * @since 08/09/2019
	 * 
	 ...
	 * @return Statistic
	 */
	public Statistic createdStatistics(List<Transaction> transactions) {
