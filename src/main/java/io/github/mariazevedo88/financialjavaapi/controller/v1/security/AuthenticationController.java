package io.github.mariazevedo88.financialjavaapi.controller.v1.security;
...
import io.github.mariazevedo88.financialjavaapi.dto.model.security.TokenDTO;
...
import io.github.mariazevedo88.financialjavaapi.util.security.JwtTokenUtil;
...
public class AuthenticationController {
	 ...
	 */
	@PostMapping
	public ResponseEntity<Response<TokenDTO>> generateTokenJwt(@RequestHeader(value=FinancialApiUtil.HEADER_FINANCIAL_API_VERSION, defaultValue = "${api.version}") 
