package io.github.mariazevedo88.financialjavaapi.controller.v1.account;
...
import io.github.mariazevedo88.financialjavaapi.exception.AccountNotFoundException;
...
public class AccountController {
	...
	/**
	 * Method that creates a account in the Financial Java API.
	 * 
	 * @author Mariana Azevedo
	 * @since 31/10/2020
	 * 
	 ...
	 */
	@PostMapping
	public ResponseEntity<Response<AccountDTO>> create(@RequestHeader(value=FinancialApiUtil.HEADER_FINANCIAL_API_VERSION, 
	...
	public ResponseEntity<Response<List<AccountDTO>>> findByAccountNumber(@RequestHeader(value=FinancialApiUtil.HEADER_FINANCIAL_API_VERSION, defaultValue="${api.version}") 
	...
	public ResponseEntity<Response<AccountDTO>> findById(@RequestHeader(value=FinancialApiUtil.HEADER_FINANCIAL_API_VERSION, 
		defaultValue="${api.version}") String apiVersion, @RequestHeader(value=FinancialApiUtil.HEADER_API_KEY, defaultValue="${api.key}") 
