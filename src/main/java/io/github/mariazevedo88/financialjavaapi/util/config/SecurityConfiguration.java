...
import io.github.mariazevedo88.financialjavaapi.filters.JwtAuthenticationEntryPointFilter;
import io.github.mariazevedo88.financialjavaapi.filters.JwtAuthenticationTokenFilter;

/**
 * Class that implements the Financial Java API Spring Security configurations.
 * 
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		if (activeProfile.equals("test")) {
        	...
        	.antMatchers("/financial/v1/auth/**", "/financial/v1/user/**", "/configuration/security", "/webjars/**", 
